...
from agents.lead_agent.prompt import get_skills_prompt_section
from agents.thread_state import ThreadState
from sandbox.security import LOCAL_BASH_SUBAGENT_DISABLED_MESSAGE, is_host_bash_allowed
from subagents import SubagentExecutor, get_available_subagent_names, get_subagent_config
from subagents.executor import SubagentStatus, cleanup_background_task, get_background_task_result, request_cancel_background_task
...
async def task_tool(
    ...
    """
    # 将任务委托给在独立上下文中运行的专用子代理。子代理自主处理复杂的多步骤任务
    # description：用于记录/显示的任务简短描述（3-5 个字）
