...
from agents.lead_agent.agent import _build_middlewares
from agents.lead_agent.prompt import apply_prompt_template
from agents.thread_state import ThreadState
from config.agents_config import AGENT_NAME_PATTERN
from config.app_config import get_app_config, reload_app_config
from config.extensions_config import ExtensionsConfig, SkillStateConfig, get_extensions_config, reload_extensions_config
...
class DeerFlowClient:
    ...
    def get_thread(self, thread_id: str) -> dict:
        ...
        checkpointer = self._checkpointer
        if checkpointer is None:
            from agents.checkpointer.provider import get_checkpointer
