...
from config.paths import VIRTUAL_PATH_PREFIX
from sandbox.exceptions import (
    SandboxError,
    SandboxNotFoundError,
    SandboxRuntimeError,
)
from sandbox.file_operation_lock import get_file_operation_lock
from sandbox.sandbox_ import Sandbox
from sandbox.sandbox_provider import get_sandbox_provider
from sandbox.search import GrepMatch
from sandbox.security import LOCAL_HOST_BASH_DISABLED_MESSAGE, is_host_bash_allowed
...
def _get_mcp_allowed_paths() -> list[str]:
    ...
    allowed_paths = []
    try:
        from config.extensions_config import get_extensions_config
